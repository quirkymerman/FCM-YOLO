"""AFPN neck ported from the paper authors' official MMYOLO implementation.
...
Official source:
    https://github.com/gyyang23/AFPN/blob/master/mmyolo/mmyolo/models/necks/yolov5_afpn.py
    inspected at commit 0930b563b43830c68825241689b80d8e430f2576

The computational graph below is kept identical to the official three-level
YOLO implementation.  The only integration changes are removing the MMYOLO
registry dependency and exporting ``AFPN`` as an alias for ``YOLOv5AFPN`` so
the neck can be imported by Ultralytics YOLO11.
"""
...
# Ultralytics-facing name; no computation is changed from the official class.
AFPN = YOLOv5AFPN
